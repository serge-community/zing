# -*- coding: utf-8 -*-
#
# Zing documentation build configuration file
#
...
latex_documents = [
    ('index', 'Zing.tex', u'Zing Documentation',
     u'Zing contributors', 'manual'),
]
...
man_pages = [
    ('index', 'zing', u'Zing Documentation',
     [u'Evernote Corporation'], 1)
]
...
texinfo_documents = [
    ('index', 'Zing', u'Zing Documentation',
     u'Zing contributors', 'Zing', 'Online translation tool.',
     'Miscellaneous'),
]
...
extlinks = {
    # :role: (URL, prefix)
    'issue': ('https://github.com/evernote/zing/issues/%s', 'issue '),
