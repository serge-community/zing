...
page_patterns = [
    ...
    url(r"^(?P<virtual_path>.+)/$", display_page, name="pootle-staticpages-display"),
]

admin_patterns = [
    url(r"^$", AdminTemplateView.as_view(), name="pootle-staticpages"),
    url(
        r"^(?P<page_type>[^/]+)/add/?$",
