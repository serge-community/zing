...
def make_store_paths_cs(apps, schema_editor):
    ...
    set_mysql_collation_for_column(
        apps, cursor, "pootle_store.Store", "pootle_path", "utf8_bin", "varchar(255)",
    )
    set_mysql_collation_for_column(
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    pootle_store.fields.TranslationStoreField(
                        ...
                        editable=False,
                        max_length=255,
                        storage=pootle.core.storage.PootleFileSystemStorage(),
                        upload_to="",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        editable=False,
                        max_length=128,
                        validators=[pootle_store.models.validate_no_slashes],
                    ),
                ),
                (
                    "file_mtime",
            ...
            bases=(
                ...
                translate.storage.base.TranslationStore,
            ),
        ),
        migrations.CreateModel(
            name="Unit",
