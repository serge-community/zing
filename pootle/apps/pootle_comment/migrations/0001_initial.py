        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_name",
                    models.CharField(
                        max_length=50, verbose_name="user's name", blank=True
                    ),
                ),
                (
                    "user_email",
                    models.EmailField(
                        max_length=254, verbose_name="user's email address", blank=True
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        default=None, verbose_name="date/time submitted", db_index=True
                    ),
                ),
                (
                    "ip_address",
