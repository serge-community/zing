...
@pytest.mark.django_db
def test_get_tasks(client, request, request_users, test_name, snapshot_stack,
                   patch_timezone_now):
...
@pytest.mark.django_db
def test_get_tasks_permissions(client, test_name, snapshot_stack, refresh_stats,
                               request, request_users, patch_timezone_now,
                               project0, hide):
    ...
    if user.username == 'member':
        _require_permission_set(user, project0.directory,
