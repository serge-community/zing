...
class TimelineEntry(object):
    ...
    def qc_entry(self):
        ...
        check_url = u"".join([reverse("pootle-checks-descriptions"), "#", check_name])
        entry.update(
            {
...
class Timeline(object):
    ...
    def submissions(self):
        ...
        return (
            ...
            .exclude(
                field=SubmissionFields.COMMENT, creation_time=self.object.commented_on
            )
            .order_by("id")
        )
    ...
    def get_entry(self, item):
        item["suggestion_comment"] = self.comment_dict.get(item["suggestion_id"])
