...
ZING_TRANSLATION_DIRECTORY = os.path.join(ROOT_DIR, "tests", "data", "po")

ZING_MT_BACKENDS = [["fake_test_backend", "api_key"]]
...
RQ_QUEUES = {
    "default": {"USE_REDIS_CACHE": "redis", "DEFAULT_TIMEOUT": 360, "ASYNC": False},
}
