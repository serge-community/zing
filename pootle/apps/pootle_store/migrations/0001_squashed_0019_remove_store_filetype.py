...
class Migration(migrations.Migration):
    ...
    replaces = [
        (b'pootle_store', '0001_initial'),
        (b'pootle_store', '0002_make_suggestion_user_not_null'),
        (b'pootle_store', '0003_remove_unit_ordering'),
        (b'pootle_store', '0004_index_store_index_together'),
        (b'pootle_store', '0005_unit_priority'),
        (b'pootle_store', '0006_remove_auto_now_add'),
        (b'pootle_store', '0007_case_sensitive_schema'),
        (b'pootle_store', '0008_flush_django_cache'),
        (b'pootle_store', '0009_store_filetype'),
        (b'pootle_store', '0010_set_store_filetypes'),
        (b'pootle_store', '0011_store_is_template'),
        (b'pootle_store', '0012_set_is_template'),
        (b'pootle_store', '0013_set_store_filetype_again'),
        (b'pootle_store', '0014_add_unit_index_togethers'),
        (b'pootle_store', '0015_add_slashes_validator_for_name'),
        (b'pootle_store', '0016_blank_last_sync_revision'),
        (b'pootle_store', '0017_remove_unit_priority'),
        (b'pootle_store', '0018_remove_store_is_template'),
        (b'pootle_store', '0019_remove_store_filetype'),
    ]
