...
js_runtime = Bundle(
    "js/runtime/app.bundle.js", output="js/runtime/app.min.%(version)s.js"
)
register("js_runtime", js_runtime)
...
js_admin_general_app = Bundle(
    "js/admin/general/app.bundle.js", output="js/admin/general/app.min.%(version)s.js"
)
register("js_admin_general_app", js_admin_general_app)

js_admin_app = Bundle(
    "js/admin/app.bundle.js", output="js/admin/app.min.%(version)s.js"
)
register("js_admin_app", js_admin_app)

js_user_app = Bundle("js/user/app.bundle.js", output="js/user/app.min.%(version)s.js")
register("js_user_app", js_user_app)

js_editor = Bundle("js/editor/app.bundle.js", output="js/editor/app.min.%(version)s.js")
register("js_editor", js_editor)

js_reports = Bundle(
    "js/reports/app.bundle.js", filters="rjsmin", output="js/reports.min.js"
)
...
css_reports = Bundle("css/reports.css", filters="cssmin", output="css/reports.min.css")
...
css_admin = Bundle(
    "css/admin.css", filters="cssmin", output="css/admin.min.%(version)s.css"
)
register("css_admin", css_admin)

css_editor = Bundle(
    "css/editor.css", filters="cssmin", output="css/editor.min.%(version)s.css"
)
